package Views.Listados.VPjornadas;
...
public class VLJornadas extends javax.swing.JFrame {

    /**
     * Crea una nueva ventana VLJornadas
     */
    public VLJornadas() {
        initComponents();
        setLocationRelativeTo(null);
        setFavicon();        
        String cadena [][] = controlador.llenarTablaJornadas(jTabla.getColumnCount());        
        jTabla.setModel(new javax.swing.table.DefaultTableModel(
                cadena,
                new String [] {
                    "Jornada", "Fecha de inicio", "Fecha de finalizacion"
                }
        ));
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VLJornadas().setVisible(true);
            }
        });
