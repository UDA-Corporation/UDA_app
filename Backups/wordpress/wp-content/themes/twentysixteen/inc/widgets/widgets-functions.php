...
function eight_degree_widgets_updated_field_value($widget_field, $new_field_value) {
    ...
    if ($eight_degree_widgets_field_tipo == 'number') {
        ...
        if (!isset($eight_degree_widgets_allowed_tags)) {
            ...
            $eight_degree_widgets_allowed_tags = '<p><strong><em><a><li>';
        }
...
function eight_degree_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($eight_degree_widgets_field_tipo) {
        ...
        case 'text' :
            ...
            <p>
                ...
                <?php if (isset($eight_degree_widgets_description)) { ?>
                    <br />
                    <small><?php echo esc_html($eight_degree_widgets_description); ?></small>
                <?php } ?>
            </p>
            <?php
            break;
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo esc_attr($instance->get_field_id($eight_degree_widgets_name)); ?>"><?php echo esc_html($eight_degree_widgets_title); ?>:</label>
                <textarea class="widefat" rows="<?php echo esc_attr($eight_degree_widgets_row); ?>" id="<?php echo esc_attr($instance->get_field_id($eight_degree_widgets_name)); ?>" name="<?php echo esc_attr($instance->get_field_name($eight_degree_widgets_name)); ?>"><?php echo esc_textarea($athm_field_value); ?></textarea>
            </p>
            <?php if (isset($eight_degree_widgets_description)) { ?>
                    <small><?php echo esc_html($eight_degree_widgets_description); ?></small>
            <?php } ?>
